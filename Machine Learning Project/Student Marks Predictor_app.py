...
app = Flask(__name__)
model = joblib.load(r"C:\Placement_Batch\Placement Batch ( Notes )\25th - Student mark prediction project\Student mark Predictor Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
